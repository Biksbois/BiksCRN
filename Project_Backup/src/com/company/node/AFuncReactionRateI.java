...
public final class AFuncReactionRateI extends PReactionRateI
{
    private PFuncCall _funcCall_;

    public AFuncReactionRateI()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAFuncReactionRateI(this);
    }
